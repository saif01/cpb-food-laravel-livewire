...
<h1>.</h1>
        <section class="hero" id="slideslow-bg">
    ...
    @push('scripts')
        ...
        $("#slideslow-bg").vegas({
            ...
            slides: [
                   ...
                   {
                        src: "{{ asset('all-assets/user/images/slider/img (1).jpg') }}"
                   },
                   {
                        src: "{{ asset('all-assets/user/images/slider/img (2).jpg') }}"
                   },
                   {
                        src: "{{ asset('all-assets/user/images/slider/img (3).jpg') }}"
                   }
