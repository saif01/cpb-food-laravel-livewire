                        ...
                        @foreach ($allData as $row )
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            <h5><a href="{{ url('/posts-details/'.$row->id) }}">{{ Str::limit($row->title, 30 ) }}</a></h5>
                                            <div class="product-name" style="height: 166px;">{!! Str::limit($row->details, 300, '......') !!}  <a href="{{ url('/posts-details/'.$row->id) }}"> Read More.</a></div>

                                            <div class="price-btn-block"> <span class="price"></span>

                                                <a href="{{ url('/posts-details/'.$row->id) }}" class="btn theme-btn-dash pull-right">View Details</a>
