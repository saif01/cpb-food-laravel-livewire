...
@section('content')
 ...
 <section class="hero bg-image" id="slideslow-bg">
            <div class="hero-inner">

                <p class="tlt animated_text">CP Five Star</p>
                <!-- <h2 class="tlt text-primary">We Believe In Better Quelity And Service </h2> -->

                <div class="container text-center hero-text font-white">
                    <h1 class="tlt" style="color:#fdbc56; text-shadow: 4px 4px 4px #e51937;" >We Believe In Better Quelity And Service</h1>
                    <h5 class="font-white space-xs">Are you finding restaurant special and delicious ?</h5>
  ...
  <section>
            <div class="title text-xs-center m-b-30 m-t-30">
                ...
                <p class="lead">Thes products are available in your nearest C.P. Five Star outlate</p>
            </div>
            <div class="row" style="background-image: url({{ asset('user/images/bg/img1.jpg') }});background-size: cover;">

                <div class="col-md-12 row roundDiv text-xs-center m-t-30">

                    <div class="col-md-4">
                        <a href="{{ url('/products') }}">
                            <img src="{{ asset('user/images/bg/CrispyChickenBurger.jpg') }}" class="round_img">
                            <p class="btn theme-btn-dash m-t-30">Crispy Chicken Burger</p>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="{{ url('/products') }}">
                            <img src="{{ asset('user/images/bg/ChickenLollipop.jpg') }}" class="round_img">
                            <p class="btn theme-btn-dash m-t-30">Chicken Lollipop</p>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="{{ url('/products') }}">
                            <img src="{{ asset('user/images/bg/SpicyChicken.jpg') }}" class="round_img">
                            <p class="btn theme-btn-dash m-t-30">Spicy Chicken</p>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="popular">
             <div class="container">
                  <div class="title text-xs-center m-b-30">
                     <h2>Latest Posts...</h2>
                    <p class="lead">The easiest way to find your nearest C.P. Five Star Outlate</p>
                </div>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                            <div class="food-item-wrap">
                                ...
                                <div class="content">
                                    <h5><a href="{{ url('/posts-details/'.$rowPost->id) }}">{{ str_limit($rowPost->title, $limit = 30 ) }}</a></h5>
                                    <div class="product-name"> {!! str_limit($rowPost->details, $limit = 300, $end = '......') !!} <a href="{{ url('/posts-details/'.$rowPost->id) }}"> Read More.</a></div>

                                    <div class="price-btn-block"> <span class="price"></span> <a href="{{ url('/posts-details/'.$rowPost->id) }}" class="btn theme-btn-dash pull-right">View Details</a> </div>
                                </div>
                ...
                <p class="lead">The easiest way to find your nearest C.P. Five Star Outlate</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                            <div class="food-item-wrap">
                                <div class="figure-wrap bg-image zoom">
                                    <img src="{{ asset($rowProduct->image1) }}" height="211" width="392">
                                    <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                </div>
                                <div class="content">
                                    <h5><a href="{{ url('/products-details/'.$rowProduct->id) }}">{{ str_limit($rowProduct->title, $limit = 30 ) }}</a></h5>
                                    <div class="product-name"> {!! str_limit($rowProduct->details, $limit = 300, $end = '......') !!} <a href="{{ url('/products-details/'.$rowProduct->id) }}"> Read More.</a></div>

                                    <div class="price-btn-block"> <span class="price">{{ $rowProduct->price }}/= Taka</span> <a href="{{ url('/products-details/'.$rowProduct->id) }}" class="btn theme-btn-dash pull-right">View Details</a> </div>
                                </div>
